...
classes = ['firstresistance','seconddiode','pnp','firstdiode','secondresistance','capacitor','gnd','amplifier','firstled','firstpolarcapacitor','npn',
           'inductor','light','rectifierbridge','battery','transformer','secondled','fuse','secondpolarcapacitor','loudspeaker','mos',]

parser = argparse.ArgumentParser()
parser.add_argument('--image_path', default='dataset/images/test',type=str, help="path of images")
parser.add_argument('--label_path', default='dataset/labels/test',type=str, help="path of labels .txt")
