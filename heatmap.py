...
class yolov8_heatmap:
    ...
    def process(self, img_path, save_path):
        save_path = 'E:/MYP/ultralytics-main/heatmap'
        # img process
        ...
        cam_image.save(r'E:/MYP/ultralytics-main/heatmap.png')
...
def get_params():
    params = {
        'weight': 'runs/train/v8s-asf2/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'E:/MYP/ultralytics-main/dataset/images/test/133.jpg', 'result')