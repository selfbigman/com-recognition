...
if __name__ == '__main__':
    ...
    parser.add_argument('--base-weights', type=str, default='runs/prune/sgm-slim-200-prune/weights/model_c2f_v2.pt', help='base weights path')
    parser.add_argument('--prune-weights', type=str, default='runs/prune/sgm-slim-200-prune/weights/prune.pt', help='prune weights path')
